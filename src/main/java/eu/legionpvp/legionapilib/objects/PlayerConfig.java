...
public class PlayerConfig extends ApiObject{
	public Integer autoAuthMethod;
	public Boolean isTagOn, isStatsPublic, isTeamChannelOn, isLocalChannelOn, isClassChannelOn;
}
