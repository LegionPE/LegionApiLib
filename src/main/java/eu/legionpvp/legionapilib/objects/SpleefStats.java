...
public class SpleefStats extends ApiObject{
	public Timestamp since;
	public Integer wins;
	public Double avgWinTotal;
	public Integer losses;
	public Double avgLoseTotal;
	public Double avgLoseLeft;
	public Integer draws;
	public Double avgDrawTotal;
	public Double avgDrawLeft;
}
